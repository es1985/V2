...
var game_manager = 
{
  ...
  notifications:0,
  dead:0,
  health_timer:setInterval(function(){},1000),
  level_modal_open:0,
  modal_cue:[],
  message_number:0,
  emoticon_number:0,
...
*/
 ...
 configure_for_cat: function()
  ...
  put_emoticon: function(emoti,sender)
  {
    ...
    var chat_message='<li class="chat-message2"><span class="chat-name">'+sender+'</span><img class="sent-emoticon" src="'+get_emoticon_file(emoti)+'" alt="slide 1" /></li>';
    $(".chat-thread").append(chat_message);
     this.emoticon_number++;
    $(".chat-cat-emoticon")[this.emoticon_number-1].scrollIntoView();
  },
  ...
  {
    this.health_timer=setInterval(function () {game_manager.hunger_tick()}, 10000);
  },
